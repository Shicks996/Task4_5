...
public class EmptySearchSteps {
    ...
    public void verifyErrorMessage() {
        WebElement error = driver.findElement(By.cssSelector(".search-suggestion__header")); // можешь уточнить
    ...
    public void the_user_clicks_the_search_icon_without_typing_anything() {
        WebDriver driver = MyDriver.getDriver(); // или используйте ваш способ получения драйвера
